...
export const spaceMemoryTaxonomy: SpaceMemoryCategory[] = [
  {
    id: "campus_youth",
    name: "校园 / 教室 / 青春",
    triggers: ["教室", "黑板", "课桌", "校服", "操场", "毕业", "下课", "晚自习", "校园", "走廊", "同学"],
    emotions: ["青春", "告别", "遗憾", "夏天", "未完成感"],
  },
  {
    id: "city_park_restorative",
    name: "公园 / 草地 / 恢复性空间",
    triggers: ["公园", "草地", "树荫", "长椅", "城市绿地", "散步", "湖边", "骑行", "树影", "深圳湾"],
    emotions: ["恢复", "松弛", "呼吸感", "轻盈", "治愈"],
  },
  {
    id: "night_city_dining",
    name: "深夜城市 / 餐厅 / 微醺",
    triggers: ["餐厅", "夜晚", "灯光", "酒杯", "街角", "便利店", "出租车", "霓虹", "独处", "耳机", "舞台", "演唱会", "聚餐"],
  ...
  },
  {
    id: "daily_life_home",
    name: "日常 / 房间 / 居家",
    triggers: ["房间", "卧室", "客厅", "桌子", "沙发", "床", "台灯", "厨房", "阳台", "日常"],
